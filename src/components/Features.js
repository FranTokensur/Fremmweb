          ...
          <Row className="justify-content-center">
            <Col lg={12}>
              <div className="sec-hd">
                ...
                <h2 className="sec-title">Caracteristicas de tu página</h2>
                <span className="heading"></span>
              </div>
            </Col>
          </Row>
          <Row className="justify-content-center align-items-center">
            ...
            <div className="features-box mt-5 text-end">
                ...
                <div className="pe-3 me-5">
                  <h5 className="f-15 text-uppercase">Diseño web adaptable</h5>
                  <p className="text-muted mt-3">Hacemos que el sitio web sea adaptable a todos los dispositivos.(celular, computadora, tablet)</p>
                </div>
              </div>
