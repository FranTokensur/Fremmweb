          ...
          <div className="row justify-content-center">
            <div className="col-lg-12">
              <div className="sec-hd">
                ...
                <h2 className="sec-title">Planes</h2>
                <span className="heading"></span>
              </div>
            </div>
          </div>
            ...
            <Col lg={4} md={6} mt={4}>
              <div className="pricing-box text-center">
                <div className="px-4 py-5">
                  ...
                  <h5 className="my-4 box-heading">Basico</h5>
                  ...
                  <a href="https://api.whatsapp.com/send?phone=541137996412" target="_blank"><Button to="#" className="btn bg-gradiant mt-4 w-100">Contactar</Button></a>
            ...
            <Col lg={4} md={6} mt={4}>
              <div className="pricing-box pricing-active text-center">
                <div className="px-4 py-5">
                  ...
                  <h5 className="my-4 box-heading">Estandar</h5>
                  <ul className="pricing-team pricing-list list-unstyled mt-2 mb-0">
